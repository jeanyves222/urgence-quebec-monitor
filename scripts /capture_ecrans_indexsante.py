...
def main():
    ...
    if cible_fenetre is None:
        # Passage hors fenêtre : comportement normal, la grande majorité des
        # déclenchements aux 5 minutes se terminent ici sans rien faire.
    ...
    journaliser(journal_path, f"Début capture Index Santé {VERSION_SCRIPT}")
